...
DATABASE_URL = os.getenv("DATABASE_URL", "postgresql+asyncpg://postgres:postgres@localhost:5432/compintelmon")
DATABASE_SYNC_URL = os.getenv("DATABASE_SYNC_URL", "postgresql+psycopg2://postgres:postgres@localhost:5432/compintelmon")
